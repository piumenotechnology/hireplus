    ...
    //userPermission
    Route::get('users', 'App\Http\Controllers\Api\UserPermissionController@index');
    Route::get('users/{id}', 'App\Http\Controllers\Api\UserPermissionController@showUser');
    Route::get('getallusers', 'App\Http\Controllers\Api\UserPermissionController@getAllUsers');
    Route::put('user/{id}', 'App\Http\Controllers\Api\UserPermissionController@updateUser');
    Route::delete('user/{id}', 'App\Http\Controllers\Api\UserPermissionController@deleteUser');

    Route::get('getsubject', 'App\Http\Controllers\Api\UserPermissionController@getSubject');

    Route::get('getroles', 'App\Http\Controllers\Api\UserPermissionController@getRoles');
    Route::get('getroles/{id}', 'App\Http\Controllers\Api\UserPermissionController@getRolesById');
    Route::post('createrole', 'App\Http\Controllers\Api\UserPermissionController@createRoles');
    Route::put('editrole/{id}', 'App\Http\Controllers\Api\UserPermissionController@updateRoles');
    Route::delete('deleterole/{id}', 'App\Http\Controllers\Api\UserPermissionController@deleteRoles');

    Route::get('showpermission', 'App\Http\Controllers\Api\UserPermissionController@getAllPermission'); //not use yet
    Route::get('showuserpermission', 'App\Http\Controllers\Api\UserPermissionController@getAllUserPermissions'); //not use yet
    Route::post('createrolepermission/{slug}', 'App\Http\Controllers\Api\UserPermissionController@storePermission');
